...
export const command = {
    ...
    eslintCheck: commandFactory(E_CommandType.CLI, ESLINT_PACKAGE_NAME, `${ESLINT_CLI} ${PATH.WORKING_DIRECTORY} --no-cache`),
    eslintFix: commandFactory(E_CommandType.CLI, ESLINT_PACKAGE_NAME, `${ESLINT_CLI} ${PATH.WORKING_DIRECTORY} --fix --no-cache`),
